  ...
  fetch(weatherAPI)
    ...
    .then(function (response) {
      ...
      historyButton.className =
        "btn bg-white border history-button city-button";
...
function getForecast(zipcode) {
  ...
  fetch(forecastAPI)
    ...
    .then(function (response) {
      ...
      day1Temp.textContent =
        "Temp: " + Math.floor(response.list[3].main.temp) + "°F";
      ...
      day2Temp.textContent =
        "Temp: " + Math.floor(response.list[11].main.temp) + "°F";

      var day2Humidity = document.querySelector("#day2humidity");
      day2Humidity.className = "forecast-info";
      day2Humidity.textContent =
      ...
      day3Temp.textContent =
        "Temp: " + Math.floor(response.list[19].main.temp) + "°F";

      var day3Humidity = document.querySelector("#day3humidity");
      day3Humidity.className = "forecast-info";
      day3Humidity.textContent =
      ...
      day4Temp.textContent =
        "Temp: " + Math.floor(response.list[27].main.temp) + "°F";

      var day4Humidity = document.querySelector("#day4humidity");
      day4Humidity.className = "forecast-info";
      day4Humidity.textContent =
      ...
      day5Temp.textContent =
        "Temp: " + Math.floor(response.list[35].main.temp) + "°F";

      var day5Humidity = document.querySelector("#day5humidity");
      day5Humidity.className = "forecast-info";
      day5Humidity.textContent =
...
//       "&lon=" +
//       lon +
//       "&key=8079923170d64d1e815aaed58f097dc4&include=minutely"
//   )
//     .then(function (response) {
//       return response.json();
//     })
